...
if __name__ == '__main__':
    import sys
    try:
        result = clean('file/ph_data_clean/mapping_table', json.loads(sys.argv[1]))
        enable_print()
    except PhError as err:
        result = CleanResult(data={}, metadata={}, tag=Tag.PH_ERR, err_msg=str(err))
